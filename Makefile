...
SRC_DIR       := ${PROJ_DIR}/pylayerstates
...
build:
	pyinstaller -D -F $(shell python -m tools.resources) -n pylayerstates -c pylayerstates_cli.py
clean:
	rm -rf ${DIST_DIR} ${BUILD_DIR} *.egg-info
	rm -rf build dist pylayerstates.spec
