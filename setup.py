...
_MODULE_NAME = "pylayerstates"
_PACKAGE_NAME = 'pylayerstates'
...
setup(
    ...
    url='https://github.com/hansbug/pylayerstates',
    ...
    project_urls={
        'Bug Reports': 'https://github.com/hansbug/pylayerstates/issues',
        'Source': 'https://github.com/hansbug/pylayerstates',
        # 'Documentation': 'https://pylayerstates.hansbug.org/',
    },
)
