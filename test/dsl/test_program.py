...
class TestDSLProgram:
    @pytest.mark.parametrize(['input_text', 'expected'], [
        ('state Z;', StateDefinition(name='Z', display_name=None, statements=[])),
        ('Z;', StateDefinition(name='Z', display_name=None, statements=[])),
        ("state Z as 'Zeta';", StateDefinition(name='Z', display_name='Zeta', statements=[])),
        ("Z named 'Zeta';", StateDefinition(name='Z', display_name='Zeta', statements=[])),
        ('state Z {}', StateDefinition(name='Z', display_name=None, statements=[])),
        ("Z as 'Zeta' {}", StateDefinition(name='Z', display_name='Zeta', statements=[])),
        (
                '\n    # fuck yourself\n    /* state Z; \n    state ZZ {\n    }\n    */\n    state X {\n        -> Y;\n        state Y;\n    \n        // nihao\n        state Z as "看目前是怎么个设计+" {\n            -> Z1;\n            Z1 -> Z2 : E1;\n            Z2 -> Z3 : E1 + E2;\n    \n            Z3 -> Z4 : E4 (^2);\n        }\n    \n        TT {\n        }\n    }\n    ',
                StateDefinition(name='X', display_name=None, statements=[EntryStatement(entry='Y'),
                                                                         StateDefinition(name='Y', display_name=None,
                                                                                         statements=[]),
                                                                         StateDefinition(name='Z',
                                                                                         display_name='看目前是怎么个设计+',
                                                                                         statements=[
                                                                                             EntryStatement(entry='Z1'),
                                                                                             TransitionStatement(
                                                                                                 from_symbol='Z1',
                                                                                                 to_symbol='Z2',
                                                                                                 events=['E1'],
                                                                                             ...
                                                                                             TransitionStatement(
                                                                                                 ...
                                                                                                 events=['E4'],
                                                                                                 backward_layers=2)]),
                                                                         StateDefinition(name='TT', display_name=None,
                                                                                         statements=[])])),
    ])
